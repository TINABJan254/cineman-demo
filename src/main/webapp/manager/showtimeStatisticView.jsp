    ...
    <div class="container">
        ...
        <div class="info-section">
            <div class="movie-info">
                Phim: <span style="color: #667eea;">${sessionScope.showtimeStats[0].movie.title}</span>
            </div>
            <div class="date-info">
                Từ ngày:
                ...
                <c:choose>
                    <c:when test="${not empty showtimeStats}">
                        <c:forEach var="showtime" items="${showtimeStats}">
                            <tr onclick="viewShowtimeDetails(${showtime.id})">
                                <td>${showtime.id}</td>
                                <td>
...
<script>
    ...
    //hàm xem chi tiết suất chiếu
    function viewShowtimeDetails(showtimeId) {
        setTimeout(function() {
            const url = 'billStat?id=' + showtimeId;
